      ...
      <div class="clear"></div><br>
        <div class="form-div-signup">
          <form class="" action="addproperty.php" method="post" enctype="multipart/form-data">
            <h3>Add Property</h3>
              <p>Description<br>
              <textarea name="description" rows="6" cols="28" placeholder="Enter property description"required></textarea> </p>
              <p>Location<br>
              ...
              <p>Property Status<br>
                  <select class="" name="buildingstatus" required>
                    <option selected>Select Buidling Status</option>
                    <option>New</option>
                    <option>Old</option>
