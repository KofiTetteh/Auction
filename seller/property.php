...
$ownerid = $_SESSION['ownerid'];
  ...
  $query = "select * from property where ownerid = '$ownerid' limit $start_from,$num_per_page";
...
<html lang="en" dir="ltr">
  ...
  <body>
      ...
      <div class="pagemation">
              <div class="page">
                <?php
                  $pr_query = "select * from property where ownerid = '$ownerid' limit $start_from,$num_per_page";
