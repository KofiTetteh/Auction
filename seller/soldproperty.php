...
include("../connection.php");
  ...
  $query = "select * from property p,auction a,owner o where o.ownerid = '$ownerid' and soldstatus = 'sold' and a.propertyid = p.propertyid and o.ownerid = p.ownerid limit $start_from,$num_per_page";
