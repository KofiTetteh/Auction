...
try {
   ...
   // $mail->addBCC('bcc@example.com');
    ...
    echo "<script>alert('You registered successfully, $firstname Please check email to verify credentials'); window.location = 'verify.php'</script>";
  }else{
    echo "<script>alert('Your registration failed. Please try again'); window.location = 'signup.php'</script>";
  }
}
}
?>
        ...
        <div class="form-div-signup">
          <form class="" action="signup.php" method="post" enctype="multipart/form-data">
            <h3>Sign Up</h3>
              ...
              <p><a href="index.php">Already have an account</a>.<br><a href="reset.php">Forgot your password? </a></p>
          </form>
        </div>
  </body>
</html>
