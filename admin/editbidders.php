        ...
        <div class="form-div-signup">
          <form class="" action="update.php" method="post" enctype="multipart/form-data">
            ...
            include("../connection.php");
                      ...
                      $query = "select * from bidder where bidderid ='$getid'";
            ...
            <h3>Update Onwer Details</h3>
              <p>First Name<br>
                <input type="text" name="bidderid" value="<?php echo $row['bidderid']; ?>" hidden>
              ...
              <p> <br> <br> </p>
              <p> <br> <br> </p>
              <p> <input type="submit" name="updatebidder" value="Upadate Info"> </p>
            <?php } ?>
          </form>
        </div>
  </body>
