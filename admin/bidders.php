...
include("../connection.php");
  ...
  $query = "select * from bidder limit $start_from,$num_per_page";
  ...
  <body>
      ...
      <div class="search2">
        <form class="" action="searchowner.php" method="post">
          <h4>Search for Assest</h4>
          <input type="search" name="searchname" placeholder="Enter city">
          <input type="submit" name="search" value="Search">
          <button type="button" name="button"> <a href="addbidders.php">Add Bidder <i class="fa fa-plus"> </i></a></button>
        </form>
      </div>
      <h5>Bidders</h5>
      <div class="clear"></div>
      ...
      <div class="auction">
        <div class="description">
          ...
          <br>
          <button type="button" name="button" class="red"><i class="fas fa-trash"></i><a href="delete.php?bid=<?php echo $row['bidderid']; ?>"> Remove Bidder </a></button>
          <button type="button" name="button"><i class="fas fa-edit"></i> <a href="editbidders.php?bid=<?php echo $row['bidderid']; ?>">Edit Bidder</a></button>
                </div>
        <div class="clear">
          <br>
        </div>
