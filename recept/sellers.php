...
include("../connection.php");
  if(isset($_POST['signup'])) {
   ...
   if($_POST['password'] != $_POST['cpassword']){
     echo "<script>alert('Password do not match'); window.location = 'sellers.php'</script>";
   }else{
  $query = "insert into owner (firstname,lastname,email,phonenumber,password,address) values
...
try {
   ...
   // $mail->addBCC('bcc@example.com');
    ...
    echo "<script>alert('You registered successfully, $firstname Please check email to verify credentials'); window.location = 'sellers.php'</script>";
  }else{
    echo "<script>alert('Your registration failed. Please try again'); window.location = 'sellers.php'</script>";
  }
}
}
?>
        ...
        <div class="form-div-signup">
          <form class="" action="sellers.php" method="post" enctype="multipart/form-data">
            <h3>Add Property Onwer</h3>
              ...
              <p> <br> <br> </p>
              <p> <input type="checkbox" name="terms" required> <a href="documents/terms-and-conditions-template.pdf" download>Terms & Conditions</a> </p>
              <p> <br> <br> </p>
