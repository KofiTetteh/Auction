...
include("../connection.php");
  ...
  $query = "select * from property p, auction a, saved s, bidder b where p.propertyid = a.propertyid and s.auctionid = a.auctionid and
  s.bidderid = s.bidderid and b.bidderid = '$bidderid' limit $start_from,$num_per_page";
  ...
  <body>
      ...
      <div class="auction">
        ...
        <div class="description">
          ...
          <br>
          <button type="button" name="button"><i class="fas fa-eye"></i> <a href="view.php?aid=<?php echo $row['propertyid']; ?>">View Asset</a> </button>
          <button type="button" name="button" class="red"><i class="fas fa-trash"></i> <a href="delete.php?aid=<?php echo $row['auctionid']; ?>">Remove Asset</a></button>
          <button type="button" name="button"><i class="fas fa-money-bill"></i> <a href="addbid.php?aid=<?php echo $row['propertyid']; ?>">Bid Asset</a></button>
      </div>
      <?php } ?>
