...
$ownerid = $_SESSION['ownerid'];
  ...
  $query = "select * from property where verification = '$pending' limit $start_from,$num_per_page";
  ...
  <body>
      ...
      <div class="pagemation">
              <div class="page">
                <?php
                  $pending = 'Pending';
                  $pr_query = "select * from property where verification = '$pending' limit $start_from,$num_per_page";
